                ...
                <div class="prfpref-lftcard">
                    <div class="prfpref-infotoppnl">
                        <figure class="prfpref-img">
                            <img :src="operator?.profile_photo_url" alt="Operator Profile" />
                        </figure>
                        <h2 class="prfpref-name">{{ operator?.full_name }}</h2>
                        <p class="prfpref-email">{{ operator?.email }}</p>
                    </div>
                    <div class="prfpref-infocontnt">
                        <div class="prfpref-infocontnt-wrp">
                            <div class="prfpref-infohd">Business Name</div>
                            <div class="prfpref-info">{{ operator?.business_name ?? 'NA' }}</div>
                        </div>
                        <div class="prfpref-infocontnt-wrp">
                            <div class="prfpref-infohd">Business Type</div>
                            <div class="prfpref-info">{{ operator?.business_type ?? 'NA' }}</div>
                        </div>
                        <div class="prfpref-infocontnt-wrp">
                            <div class="prfpref-infohd">Main Destinations</div>
                            <div class="prfpref-info">
                                {{ operator?.main_destination ? operator?.main_destination.join(', ') : 'NA' }}
                            </div>
                        </div>
                    </div>
                </div>
