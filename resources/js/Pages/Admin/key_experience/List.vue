            ...
            <div class="kt-portlet__body">
                <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="kt_table_1_filter" class="dataTables_filter">
                                <Link :href="route('admin.key-experience.create')" class="btn btn-brand kt-btn btn-sm kt-btn--icon button-fx"><i class="la la-plus"></i>Add New</Link>
                            </div>
                        </div>
                    </div>
                    <div class="row table-responsive table_fixed_width">
                        <div class="col-sm-12">
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px">
                               ...
                               <tbody v-auto-animate>
                                    <tr role="row" class="odd" v-for="data in props.experience" :key="data.id">
                                        <td>{{ data.title }}</td>
                                        ...
                                        <td nowrap="" class="align-center">
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <Link class="dropdown-item" :href="route('admin.key-experience.edit', data.id)"><i class="la la-edit"></i> Edit</Link>
                        ...
                        <div class="col-sm-12" v-if="experience.length == 0">
...
const resetSearch = () => {
    router.visit(route("admin.key-experience.index"), {
        method: "get",
    });
};
...
const deleteConfirm = (id) => {
    router.delete(route("admin.key-experience.destroy", id));
};
