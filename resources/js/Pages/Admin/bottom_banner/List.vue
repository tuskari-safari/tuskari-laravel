                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="kt_table_1_filter" class="dataTables_filter">
                            <Link :href="route('admin.create-bottom-banner')"
                                    class="btn btn-brand kt-btn btn-sm kt-btn--icon button-fx"><i
                ...
                <div class="row table-responsive table_fixed_width">
                    <div class="col-sm-12">
                        <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px;">
                            <thead>
                                <tr role="row">
                                    <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 20%;" aria-sort="ascending" aria-label="Agent: activate to sort column descending">Title
                                    </th>
                                    <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 15%;" aria-sort="ascending" aria-label="Agent: activate to sort column descending">Page Name
                                    </th>
                                ...
                                <tr class="filter">
                                    ...
                                    <th>
                                        <input type="search" v-model="form.page_name" placeholder="" autocomplete="off" class="form-control-sm form-filter" />
                                    </th>
                                    <th>
                                        <div class="row justify-content-center align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <button class="mt-2 btn btn-brand kt-btn btn-sm kt-btn--icon button-fx" @click="search">
                                                    <span>
                                                ...
                                                <button class="ml-2  btn btn-secondary kt-btn btn-sm kt-btn--icon button-fx" @click="resetSearch">
                                                    <span>
                                    ...
                                    <td nowrap="" class="align-center">
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <Link class="dropdown-item" :href="`edit-bottom-banner/${banner.id}`"><i class="la la-edit"></i> Edit</Link>
                                                <!-- <button href="javascript:void(0)" class="dropdown-item"
                                                    @click="deleteRecode(banner.id)">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-7">
                    <div class="float-right">
                        <Bootstrap4Pagination :data="banners" :limit="2" @pagination-change-page="ListHelper.setPageNum" />
                    </div>
                </div>
            </div>
        </div>
...
const search = () => {
    ...
    router.visit(route("admin.bottom-banner-list"), {
        method: "get",
        data: pickBy(form),
        preserveScroll: true,
    });
...
const deleteConfirm = (id) => {
    router.delete(route("admin.delete-bottom-banner", { banner_id: id }));
};
