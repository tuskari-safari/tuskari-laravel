                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="password_box">
                            <input :type="showCurrentPassword ? 'text' : 'password'" id="current_password"
                                v-model="form.current_password" class="form-control border-gray-200"
                                placeholder="Current Password">
                            <div class="control">
                                <span class="icon is-small is-right">
                                    <i @click="showCurrentPassword = !showCurrentPassword" class="fas"
                                        :class="{ 'fa-eye-slash': showCurrentPassword, 'fa-eye': !showCurrentPassword }"></i>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="password_box">
                            <input :type="showNewPassword ? 'text' : 'password'" id="new_password"
                                v-model="form.new_password" class="form-control border-gray-200"
                                placeholder="New Password">
                            <div class="control">
                                <span class="icon is-small is-right">
                                    <i @click="showNewPassword = !showNewPassword" class="fas"
                                        :class="{ 'fa-eye-slash': showNewPassword, 'fa-eye': !showNewPassword }"></i>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="password_box">
                            <input :type="showConfirmPassword ? 'text' : 'password'" id="confirm_password"
                                v-model="form.confirm_password" class="form-control border-gray-200"
                                placeholder="Confirm Password">
                            <div class="control">
                                <span class="icon is-small is-right">
                                    <i @click="showConfirmPassword = !showConfirmPassword" class="fas"
...
function submit() {
    form.post(route('admin.changePassword'), { preserveScroll: true });
}
