                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="kt_table_1_filter" class="dataTables_filter">
                                <Link :href="route('admin.createUser')" class="btn btn-primary"><i class="la la-plus"></i>Add New</Link>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td nowrap="" class="align-center">
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <Link class="dropdown-item" :href="route('admin.booking.index', {traveler: user.full_name})"><i class="la la-eye"></i> View Order</Link>
