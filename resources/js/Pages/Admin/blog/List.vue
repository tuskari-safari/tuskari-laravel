            ...
            <div class="kt-portlet__body">
                <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="kt_table_1_filter" class="dataTables_filter">
                                <Link :href="route('admin.blog.create')" class="btn btn-primary"><i class="la la-plus"></i>Add New Blog</Link>
                            </div>
                        </div>
                    </div>
                    <div class="row table-responsive table_fixed_width">
                        <div class="col-sm-12">
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px">
                                ...
                                <tbody v-auto-animate>
                                    <tr role="row" class="odd" v-for="blog in props.blogs.data" :key="blog.id">
                                        <td>{{ blog.title }}</td>
                                        <td>{{ ListHelper.dateFormat(blog.created_at,"MMM DD, YYYY") }}</td>
                                        <td class="align-center">
                                            <span @click="changeStatus(blog.id)" style="cursor: pointer" class="kt-badge kt-badge--inline kt-badge--pill cursor-pointer" :class=" blog.status == 1? 'kt-badge--success': 'kt-badge--warning'">{{ blog.status == 1 ? "Active" : "Inactive" }}</span>
                                        </td>
                                        <td nowrap="" class="align-center">
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <Link class="dropdown-item" :href="route('admin.blog.edit', blog.id)"><i class="la la-edit"></i> Edit</Link>
                                                    <button href="javascript:void(0)" class="dropdown-item" @click="deleteRecode(blog.id)">
                        ...
                        <div class="col-sm-12" v-if="blogs.total == 0">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="float-right">
                            <Bootstrap4Pagination :data="blogs" :limit="2" @pagination-change-page="ListHelper.setPageNum" />
                        </div>
                    </div>
                </div>
            </div>
...
const changeStatusConfirm = (id) => {
    ...
    router.post(route("admin.blog.status"), data);
};
</script>
<style lang=""></style>