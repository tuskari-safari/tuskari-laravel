                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px;">
                                <thead>
                                    ...
                                    <tr role="row">
                                        <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 80%;" aria-sort="ascending" aria-label="Agent: activate to sort column descending">Page Name <i class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" @click="ListHelper.sortBy('title')"></i>
                                        </th>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="float-right">
                            <Bootstrap4Pagination :data="pages" :limit="2" @pagination-change-page="ListHelper.setPageNum" />
                        </div>
                    </div>
                </div>
            </div>
