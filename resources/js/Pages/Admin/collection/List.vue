            ...
            <div class="kt-portlet__body">
                <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="kt_table_1_filter" class="dataTables_filter">
                                <Link :href="route('admin.collection.create')" class="btn btn-brand kt-btn btn-sm kt-btn--icon button-fx">
                    ...
                    <div class="row table-responsive table_fixed_width">
                        <div class="col-sm-12">
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px">
                                ...
                                <tbody v-auto-animate>
                                    <tr role="row" class="odd" v-for="data in props.collections" :key="data.id">
                                        <td>{{ data.name }}</td>
                                        ...
                                        <td nowrap="" class="align-center">
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <Link class="dropdown-item" :href="route('admin.collection.edit', data.id)">
                        ...
                        <div class="col-sm-12" v-if="collections.length == 0">
...
onMounted(() => {
    ...
    props.collections.forEach(collection => {
        safariSelections[collection.id] = collection.safaris.map(s => s.id);
    });
...
const resetSearch = () => {
    router.visit(route("admin.collection.index"), {
        method: "get",
    });
};
...
const changeStatusConfirm = (id) => {
    ...
    router.post(route("admin.collection.status"), data);
};
...
const deleteConfirm = (id) => {
    router.delete(route("admin.collection.destroy", id));
};
...
const saveSafariCollection = (id) => {
    ...
    if (payload.safari_ids.length == 0) {
        toaster.error("Collection safari is required");
        
    }
    router.post(route("admin.safari-collection"), payload);
};
