            ...
            <div class="kt-portlet__body">
                <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="kt_table_1_filter" class="dataTables_filter">
                                <Link :href="route('admin.activity.create')" class="btn btn-brand kt-btn btn-sm kt-btn--icon button-fx"><i class="la la-plus"></i>Add New</Link>
                            </div>
                        </div>
                    </div>
                    <div class="row table-responsive table_fixed_width">
                        <div class="col-sm-12">
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px">
                               ...
                               <tbody v-auto-animate>
                                    <tr role="row" class="odd" v-for="data in props.activity" :key="data.id">
                                        <td class="align-center">
                                            <div class="activity-logo">
                                                <img v-if="data?.full_icon_url" 
                                                     :src="data.full_icon_url" 
                                                     :alt="data.title" 
                                        ...
                                        <td nowrap="" class="align-center">
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <Link class="dropdown-item" :href="route('admin.activity.edit', data.id)"><i class="la la-edit"></i> Edit</Link>
                        ...
                        <div class="col-sm-12" v-if="activity.length == 0">
...
const resetSearch = () => {
    router.visit(route("admin.activity.index"), {
        method: "get",
    });
};
