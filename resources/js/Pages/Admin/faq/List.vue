        ...
        <div class="kt-portlet__body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="kt_table_1_filter" class="dataTables_filter ">                            
                            ...
                            <Link href="/admin/faq/create" class="btn btn-primary"><i class="la la-plus"></i>Add New</Link>
                        </div>
                    </div>
                </div>
                        ...
                        <table
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1"
                                        ...
                                        Answer
                                        <i class="fa fa-fw fa-sort pull-right" style="cursor: pointer"
                                            @click="ListHelper.sortBy('answer')"></i>
                                    </th>
                                ...
                                <tr class="filter">
                                    ...
                                    <th>
                                        <input type="search" v-model="form.answer" placeholder=""
                                            autocomplete="off" class="form-control-sm form-filter" />
                                    </th>
                                    <th>
                            ...
                            <tbody v-auto-animate>
                                <tr role="row" class="odd" v-for="faq in faqs.data" :key="faq.id">
                                    ...
                                    <td>
                                        <span @click="changeStatus(faq.id)" style="cursor: pointer"
                                            class="kt-badge kt-badge--inline kt-badge--pill cursor-pointer"
                                            :class="faq.active == 1 ?
                                                'kt-badge--success' :
                                                'kt-badge--warning'">{{ faq . active == 1 ? 'Active' : 'Inactive' }}</span>
                                    </td>
                                    <td nowrap="" class="align-center">
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <Link class="dropdown-item" :href="`faq/${faq.id}/edit`"><i
                                                    class="la la-edit"></i>
                                                Edit</Link>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-5">
                    <div v-if="faqs.total != 0" class="dataTables_info" id="kt_table_1_info" role="status" aria-live="polite">
                        Showing {{ faqs.from ?? 0 }} to {{ faqs.to ?? 0 }} of
                        {{ faqs.total }} entries
                    </div>
                </div>
                <div class="col-sm-12 col-md-7">
                    <div class="float-right">
                        <Bootstrap4Pagination :data="faqs" :limit="2"
