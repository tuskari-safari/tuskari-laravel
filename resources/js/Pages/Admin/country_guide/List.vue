<template lang="">
    <div>
        <Head title="Country Guide Lists" />
            ...
            <div class="kt-portlet__body">
                <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="kt_table_1_filter" class="dataTables_filter">
                                <Link :href="route('admin.country-guide.create')" class="btn btn-primary"><i class="la la-plus"></i>Add New </Link>
                            </div>
                        </div>
                    </div>
                    <div class="row table-responsive table_fixed_width">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 1115px">
                                <thead>
                                    ...
                                    <tr class="filter">
                                        ...
                                        <th>
                                            <select class="form-control form-control-sm form-filter kt-input" v-model="form.region" title="Select" data-col-index="2">
                                ...
                                <tbody v-auto-animate>
                                    <tr role="row" class="odd" v-for="country in props.countries.data" :key="country.id">
                                        ...
                                        <td class="align-center">
                                            <span @click="changeStatus(country.id)" style="cursor: pointer" class="kt-badge kt-badge--inline kt-badge--pill cursor-pointer" :class=" country.status == 1? 'kt-badge--success': 'kt-badge--warning'">{{ country.status == 1 ? "Active" : "Inactive" }}</span>
                                        </td>
                                        ...
                                        <td nowrap="" class="align-center">
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <Link class="dropdown-item" :href="route('admin.country-guide.edit', country.id)"><i class="la la-edit"></i> Edit</Link>
                                                    <button href="javascript:void(0)" class="dropdown-item" @click="deleteRecode(country.id)">
                        ...
                        <div class="col-sm-12" v-if="countries.total == 0">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="float-right">
                            <Bootstrap4Pagination :data="countries" :limit="2" @pagination-change-page="ListHelper.setPageNum" />
                        </div>
                    </div>
                </div>
            </div>
...
const resetSearch = () => {
    router.visit(route("admin.country-guides"), {
        method: "get",
    });
};
...
const deleteConfirm = (id) => {
    router.delete(route("admin.country-guide.destroy", id));
};
...
const changeStatusConfirm = (id) => {
    ...
    router.post(route("admin.country-guide.status"), data);
};
</script>
<style lang=""></style>