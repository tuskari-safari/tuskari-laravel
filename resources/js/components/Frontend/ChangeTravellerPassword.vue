                        ...
                        <div class="row form_row">
                            <div class="col-12 form_col">
                                ...
                                <div class="input_hldr">
                                    ...
                                    <span class="text-danger" v-if="form.errors.current_password">{{
                            ...
                            <div class="col-12 form_col">
                                ...
                                <div class="input_hldr">
                                    ...
                                    <span class="text-danger" v-if="form.errors.new_password">{{
...
const handleChangePassword = () => {
    form.post(route('frontend.traveller-change-password'), {
        onSuccess: () => {
