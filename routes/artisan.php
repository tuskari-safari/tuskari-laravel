...
if (config('app.artisan') == 1) {
    ...
    Route::get('auto-pay', function () {
        Artisan::call('payments:auto-charge');
        return 'payments auto-charge done.';
    });
     Route::get('exchange:fetch', function () {
        Artisan::call('exchange:fetch');
        return 'exchange fetch done.';
    });
}
